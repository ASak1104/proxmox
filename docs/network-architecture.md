...
| **Authelia** | **201** | **10.1.0.101** | 9091 | SSO/OIDC |
...
OPNsense (VM 102, <OPNSENSE_WAN_IP>)
  ...
  │                                             │  Host 헤더 기반 라우팅
  │                                             ├─ authelia.cp.codingmon.dev   ──▶ 10.1.0.101:9091  (Authelia)
...
| authelia.cp.codingmon.dev | OPNsense HAProxy (102) | CP Traefik (200) | 10.1.0.101:9091 | HTTP |
...
#### HTTPS Frontend (`:443`)
- **SSL Offloading**: ✅ (Let's Encrypt 7-도메인 SAN)
- **ACLs**:
